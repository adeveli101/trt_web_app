...
export default function PastPresentFutureSpread({ selectedCards, meaningTitles, meanings }: {
  ...
  return (
    <div className="flex flex-col items-center w-full gap-4">
      <div className="flex flex-row flex-wrap justify-center items-end gap-4 w-full">
        {[0,1,2].map(i => (
          <div key={i} className="flex flex-col items-center flex-1 min-w-[80px] max-w-[180px]">
