...
export default function IntroSection() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-[80vh] md:min-h-[90vh] px-4 py-12 md:py-20 bg-gradient-to-br from-[var(--primary-color)] via-[#3a1053] to-[var(--bg-color)] overflow-hidden">
      ...
      >
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white mb-4 text-center drop-shadow-lg tracking-wide animate-fade-in"
        ...
        <motion.p
          ...
          className="text-lg sm:text-xl md:text-2xl text-[var(--text-muted-color)] mb-8 max-w-2xl text-center animate-fade-in"
